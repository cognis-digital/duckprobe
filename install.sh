#!/usr/bin/env sh
# Universal installer for duckprobe. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/duckprobe.git"
echo "Installing duckprobe ..."
