...
[![PyPI](https://img.shields.io/pypi/v/cognis-duckprobe.svg)](https://pypi.org/project/cognis-duckprobe/)
[![CI](https://github.com/cognis-digital/duckprobe/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/duckprobe/actions)
...
DUCKPROBE exists for one job — zero-setup data-quality checks on any file or warehouse via duckdb — and does it without a SaaS bill or heavyweight setup.
...
```bash
duckprobe --version
duckprobe scan .                      # scan the current project
duckprobe scan . --format json
duckprobe scan . --fail-on high       # non-zero exit for CI gates
duckprobe mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Soda Core + DuckDB**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`duckprobe` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
