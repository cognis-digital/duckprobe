...
import argparse, sys
from duckprobe.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="duckprobe", description="DUCKPROBE — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from duckprobe.mcp_server import serve
        return serve()
    if args.cmd == "scan":
