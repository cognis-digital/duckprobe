"""DUCKPROBE core — Zero-setup data-quality checks on any file or warehouse via DuckDB."""
...
RULES = [
    ("DUC-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("DUC-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("DUC-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
